...
//			BoltzmannQPolicy bp = new BoltzmannQPolicy(agent, 0.5);
//			agent.setLearningPolicy(bp);
//			p = bp;		
			
			EpsilonGreedy bp = new EpsilonGreedy(agent, 0.1);
			agent.setLearningPolicy(bp);
			p = bp;	
			
//			RandomPolicy bp = new RandomPolicy(domain);
//			agent.setLearningPolicy(bp);
//			p = bp;	
